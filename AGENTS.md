...
- **Dokumentation immer aktuell halten** – nach jeder Entscheidung und nach jeder Umsetzung:
  ...
  - `AGENTS.md` — SW-Version, Kerndatenmodell, Architekturentscheidungen aktuell halten
...
- `AGENTS.md` (diese Datei) — SW-Version, Statusübersicht Freemium-Plan, Architekturentscheidungen
...
2. Statusübersicht in AGENTS.md aktualisieren
