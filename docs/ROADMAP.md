...
| # | Feature | Status | Datum |
|---|---|---|---|
| 7.0 | **Landing Page Design + Content Improvements (P1 + P2)** – Hero-Kontrast, Gradient, neuer CTA-Button, H1-Headline, Typography, Tool-Card-Farben (violet→primary), SEO-H2 differenziert, Preishinweis nach CTA, Prefooter-CTA-Text, Business-Plantext, AGB-Modal-Inline-Styles extrahiert, Footer-Brand-Desc bereinigt. Audit-Basis: `docs/webdesign/audit-fordify-landingpage.md` | ✅ | 2026-05-05 |
| 7.0b | **P3 UX-Fixes + PKH-Kalkulator** – Touch-Targets Vergleichstabelle, MwSt-Hinweis sichtbar, SVG-Lock-Icon, Prefooter Preisseite kontextspezifisch. Neue Seite `/pkh-rechner` (§ 49 RVG). Nav/Footer sitewide: Tilgungsrechner → PKH-Kalkulator. Copyright + brand-desc Rechner-Seiten harmonisiert. | ✅ | 2026-05-05 |
...
| 7.3 | **SEO-Landingpages prüfen** – Ergibt es Sinn, dedizierte SEO-Unterseiten zu erstellen (z.B. für "Forderungsaufstellung §367 BGB", "Verzugszinsen berechnen" etc.)? Keyword-Recherche, Wettbewerbsanalyse und Aufwand-/Nutzen-Abwägung gegenüber Optimierung bestehender Seiten. | 📋 | — |
